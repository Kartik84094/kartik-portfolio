    ...
    return (
        <div>
            <section>
                <div className='grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6'>
                    <div>
                        ...
                        <p className="mt-4 max-w-xl text-sm sm:text-base pr-4">
                            I’m a full-stack software engineer with a focus on building high-performance, scalable web applications using the MERN stack (MongoDB, Express.js, React, Node.js). My toolbox includes Redux for state management, TypeScript for type safety, and Docker for containerization and deployment.
                            <br /><br />
                            I’m passionate about clean code, intuitive UIs, and solving real-world problems through tech. Take a look at my portfolio or reach out to see how I can contribute to your next project.
                        </p>
                    </div>

                    <div className='flex justify-content-center align-items'><img src='images/tech.webp' alt='' className="w-full h-full object-cover" /></div>
          ...
          <button className="bg-blue-600 px-4 py-2 rounded text-white hover:bg-blue-700 w-full sm:w-auto"><a href="resume" className="">📄 View Resume</a></button>
            ...
            <section className="mt-12 border-t border-gray-700">
                <h2 className="text-2xl font-bold mb-2 mt-12">💡 What I do</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
                    ...
                    <SkillCard title="Git, GitHub & Postman" icon="☁️" description="Git is a distributed version control system that helps developers track changes, collaborate, and manage source code history efficiently." />
